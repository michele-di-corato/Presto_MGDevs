                ...
                <div class="card card-pers card-elem px-3 pb-3">
                    ...
                    <div class="card card-bg p-3">
                        <form method="POST" action="{{ route('register') }}">
                            @csrf
                            <div class="mb-3">
                                <input type="text" class="py-3 form-control @error('name') is-invalid @enderror"
                                    id="inputName" name="name" value="{{ old('name') }}"
                                    placeholder="{{ __('ui.register-name-placehold') }}">
                                @error('name')
                            ...
                            <div class="mb-3">
                                <input type="email" class="py-3 form-control @error('email') is-invalid @enderror"
                                    ...
                                    placeholder="{{ __('ui.register-email-placehold') }}">
                                @error('email')
                                    <div class="text-danger pt-1">
                                        <p>{{ $message }}</p>
                                    </div>
                            ...
                            <div class="mb-3">
                                <input type="password" class="py-3 form-control @error('password') is-invalid @enderror"
                                    ...
                                    placeholder="{{ __('ui.register-password-placehold') }}">
                                @error('password')
                                    <div class="text-danger pt-1">
                                        <p>{{ $message }}</p>
                                    </div>
                            ...
                            <div class="mb-3">
                                <input type="password"
                                    class="py-3 form-control @error('password_confirmation') is-invalid @enderror"
                                    id="password_confirmation" name="password_confirmation"
                                    placeholder="{{ __('ui.register-confirmation-placehold') }}">
